...
import com.example.capstone2project.databinding.FoodCaloriesBinding;
...
public class FoodActivity extends AppCompatActivity {
    ...
    private FoodCaloriesBinding binding;
    ...
    private List<FoodDataActivity> foodDataList = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        // Menginflasikan layout menggunakan view binding
        binding = FoodCaloriesBinding.inflate(getLayoutInflater());
        ...
        binding.scheduleBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Membuat Intent untuk membuka ActivityHomePage
                Intent intent = new Intent(FoodActivity.this, ScheduleActivity.class);
        ...
        collectionReference.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(FoodActivity.this, "Gagal mengambil data: " + task.getException(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void handleQuerySnapshot(QuerySnapshot querySnapshot) {
        if (querySnapshot != null && !querySnapshot.isEmpty()) {
            ...
            for (QueryDocumentSnapshot document : querySnapshot) {
                ...
                FoodDataActivity food = new FoodDataActivity(
                        (String) data.get("id"),
            ...
            if (foodDataList.size() > 0) {
                ...
                Toast.makeText(FoodActivity.this, "Tidak ada hasil pencarian", Toast.LENGTH_SHORT).show();
            }
        } else {
            Toast.makeText(FoodActivity.this, "Koleksi kosong", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private FoodAdapter.OnItemClickListener onClicked = new FoodAdapter.OnItemClickListener() {
        @Override
        public void onClicked(FoodDataActivity food) {
    ...
    private void searchFood(String query) {
        ...
        if (TextUtils.isEmpty(query) && foodDataList.size() > 0) {
            ...
            List<FoodDataActivity> listSearch = new ArrayList<>();

            // Iterasi melalui setiap item makanan dalam daftar asli
            for (FoodDataActivity food : foodDataList) {

...
import com.example.capstone2project.databinding.ListFoodcalBinding;
 ...
 */
public class FoodAdapter extends ListAdapter<FoodDataActivity, FoodAdapter.FoodViewHolder> {
    ...
    public interface OnItemClickListener {
        void onClicked(FoodDataActivity food);
    }
    ...
    static class FoodViewHolder extends RecyclerView.ViewHolder {
         ...
         */
        public void bind(FoodDataActivity food) {
     ...
     */
    private static final DiffUtil.ItemCallback<FoodDataActivity> diffCallback = new DiffUtil.ItemCallback<FoodDataActivity>() {
        @Override
        public boolean areItemsTheSame(FoodDataActivity oldItem, FoodDataActivity newItem) {
            return oldItem.getId() == newItem.getId();
        }

        @Override
        public boolean areContentsTheSame(FoodDataActivity oldItem, FoodDataActivity newItem) {

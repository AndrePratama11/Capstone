...
import com.example.capstone2project.databinding.HomeBinding;
import com.example.capstone2project.databinding.HomeBinding;
...
public class HomeActivity extends AppCompatActivity {
        ...
        collectionReference.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(HomeActivity.this, "Gagal mengambil data: " + task.getException(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void handleQuerySnapshot(QuerySnapshot querySnapshot) {
        if (querySnapshot != null && !querySnapshot.isEmpty()) {
            ...
            if (homeBeginnerList.isEmpty()&& homeIntermediateList.isEmpty()&& homeProList.isEmpty() ){
                Toast.makeText(HomeActivity.this, "Tidak ada hasil pencarian", Toast.LENGTH_SHORT).show();
            }
            ...
            Toast.makeText(HomeActivity.this, "Koleksi kosong", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private HomeAdapter.OnItemClickListener onClicked = new HomeAdapter.OnItemClickListener() {
        ...
        public void onClicked(HomeData data) {
            ...
            Intent intent = new Intent(HomeActivity.this, HomePageDetailActivity.class);
